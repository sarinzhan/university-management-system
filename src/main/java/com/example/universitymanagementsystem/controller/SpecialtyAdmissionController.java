...
public class SpecialtyAdmissionController {
    ...
    public CommonResponseDto<List<FacultyAdmissionResponseDto>> getFacultiesAdmissions(){
        return new CommonResponseDto<List<FacultyAdmissionResponseDto>>()
                .setOk()
                .setData(
                        facultyAdmissionResponseMapper.listEntityToDto(
